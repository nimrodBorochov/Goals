...
final class IssuesUITests: XCTestCase {
    ...
    func testEditingIssueTitleUpdatesCorrectly() {
        ...
        app.buttons["Issues"].tap()
        XCTAssertTrue(app.buttons["My New Issue"].exists, "A My New Issue should now exists.")
    }

    func testEditingIssuePriorityShoesIcon() {
        app.buttons["New Issue"].tap()
