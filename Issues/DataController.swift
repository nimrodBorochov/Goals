...
class DataController: ObservableObject {
    ...
    func createSampleData() {
        ...
        for tagCounter in 1...5 {
            ...
            for issueCounter in 1...10 {
                ...
                issue.title = String.localizedStringWithFormat(
                    NSLocalizedString("Issue %d-%d", comment: "Create a Sample Data"),
                    tagCounter, issueCounter
                )
                issue.content = NSLocalizedString("Description goes here", comment: "Create a Sample Data")
    ...
    func hasEarned(award: Award) -> Bool {
        ...
        case "issues":
            // return true if they added a creation number of issue
            let fetchRequest = Issue.fetchRequest()
            let awardCount = count(for: fetchRequest)
            return awardCount >= award.value

        case "closed":
            // return true if they closed a creation number of issue
            let fetchRequest = Issue.fetchRequest()
